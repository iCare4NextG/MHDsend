...
SET CP=%CP%;%MHDSEND_HOME%\lib\hapi-fhir-base-4.0.3.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\hapi-fhir-client-4.0.3.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\hapi-fhir-structures-r4-4.0.3.jar
...
SET CP=%CP%;%MHDSEND_HOME%\lib\javax.servlet-api-3.1.0.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\jcl-over-slf4j-1.7.25.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\jetty-http-9.4.14.v20181114.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\jetty-io-9.4.14.v20181114.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\jetty-server-9.4.14.v20181114.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\jetty-util-9.4.14.v20181114.jar
...
SET CP=%CP%;%MHDSEND_HOME%\lib\org.hl7.fhir.r4-4.0.3.jar
SET CP=%CP%;%MHDSEND_HOME%\lib\org.hl7.fhir.utilities-4.0.3.jar
